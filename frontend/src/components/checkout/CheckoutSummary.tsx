...
export default function CheckoutSummary({ cart }: { cart: CartProduct[] }) {
    ...
    return (
        <div className="mx-auto mt-6 max-w-4xl flex-1 space-y-8 lg:mt-0 lg:w-full">
            <div className="space-y-4 rounded-lg border border-gray-200 bg-white p-6 shadow-sm sm:p-8">
