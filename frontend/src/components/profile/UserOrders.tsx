...
function UserOrders() {
    ...
    return (
        <section className="bg-amber-50 pt-5 pb-8 antialiased md:pt-5 md:pb-16">
            <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
                <h1 className="text-xl font-semibold text-gray-900 sm:text-2xl mt-0 text-center">Orders</h1>
                    ...
                    <div className="mt-6 sm:mt-8 md:gap-6 lg:flex lg:items-start xl:gap-8">
                        <div className="mx-auto w-full flex-none lg:max-w-2xl xl:max-w-4xl">
                            <div className="space-y-6">
                                {data?.orders?.slice().reverse().map((item: any) => (
                                    <OrderItem item={item} />
                                ))}
                            </div>
                        </div>
