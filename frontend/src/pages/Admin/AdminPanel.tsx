        ...
        <div className="flex-1 lg:left-0 p-2 w-[200px] overflow-y-auto text-center ">
            <div className="text-xl">
                <div className="p-2.5 mt-1 flex items-center">
                    {displayedScreen === "panel" && <i className="bi bi-app-indicator px-2 py-1 rounded-md bg-blue-600"></i>}
                    <h1 className="font-bold text-black text-[15px] ml-3">Admin Panel</h1>
                    <i
            ...
            >
                ...
                <span className="text-[15px] text-black ml-4 font-bold">Review Approval </span>
            </div>
            ...
            >
                {displayedScreen === "productManagement" && <i className="bi bi-app-indicator px-2 py-1 rounded-md bg-blue-600"></i>}
                <span className="text-[15px] ml-4 text-black font-bold">Product Management</span>
            </div>
